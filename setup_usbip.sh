...
case "$ACTION" in
    start|--start)
        ...
        echo "    usbipd attach --remote $IP --busid $BUSID"
        echo "================================================"
        ;;
...
echo ""
echo "Pa Windows-PC:"
echo "  1. Installer usbipd-win: winget install usbipd"
echo "  2. Koble til:  usbipd attach --remote <PI-IP> --busid <BUS-ID>"
echo "  3. Start DewesoftX - SIRIUS dukker opp som lokal enhet"
echo ""
